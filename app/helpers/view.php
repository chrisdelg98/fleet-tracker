...
function nav_icon(string $ruta): string
{
    $path = match ($ruta) {
        ...
        '/mantenimientos' => 'M10 2.6a1 1 0 0 1 .96.73l.4 1.4a5.6 5.6 0 0 1 1.3.75l1.4-.43a1 1 0 0 1 1.16.45l1 1.74a1 1 0 0 1-.2 1.24l-1.07.95c.05.28.07.57.07.86s-.02.58-.07.86l1.07.95a1 1 0 0 1 .2 1.24l-1 1.74a1 1 0 0 1-1.16.45l-1.4-.43c-.4.3-.83.56-1.3.75l-.4 1.4a1 1 0 0 1-.96.73h-2a1 1 0 0 1-.96-.73l-.4-1.4a5.6 5.6 0 0 1-1.3-.75l-1.4.43a1 1 0 0 1-1.16-.45l-1-1.74a1 1 0 0 1 .2-1.24l1.07-.95A5.7 5.7 0 0 1 3.1 10c0-.29.02-.58.07-.86L2.1 8.19a1 1 0 0 1-.2-1.24l1-1.74a1 1 0 0 1 1.16-.45l1.4.43c.4-.3.83-.56 1.3-.75l.4-1.4a1 1 0 0 1 .96-.73h2ZM10 7.6a2.4 2.4 0 1 0 0 4.8 2.4 2.4 0 0 0 0-4.8Z',
        '/proveedores' => 'M3 8.3 4.7 3.9A1.5 1.5 0 0 1 6.1 3h7.8a1.5 1.5 0 0 1 1.4.9L17 8.3V16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8.3Zm2 1.7v5h3v-3h4v3h3v-5H5Zm-.1-1.8h10.2l-1.1-3.2H6l-1.1 3.2Z',
        ...
        '/admin/estaciones' => 'M3 21V6a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v3h4a2 2 0 0 1 2 2v10H3Zm3-11h3V7H6v3Zm0 5h3v-3H6v3Zm0 5h3v-3H6v3Zm5-10h3V7h-3v3Zm0 5h3v-3h-3v3Zm0 5h3v-3h-3v3Zm5 0h3v-3h-3v3Zm0-5h3v-3h-3v3Z',
        '/admin/usuarios' => 'M9 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm7.6 0a3.1 3.1 0 1 0 0-6.2 3.1 3.1 0 0 0 0 6.2ZM2 19.6C2 16.5 5.13 14 9 14s7 2.5 7 5.6V21H2v-1.4Zm15.6-4.4c2.45 0 4.4 1.7 4.4 3.8V21h-4.5v-1.4c0-1.45-.42-2.8-1.15-3.95.4-.3.79-.45 1.25-.45Z',
        '/admin/catalogos' => 'M12 2.4 22.2 8 12 13.6 1.8 8 12 2.4Zm7.9 8.2 2.3 1.3L12 17.5 1.8 11.9l2.3-1.3L12 14.9l7.9-4.3Zm0 4.6 2.3 1.3L12 22.1 1.8 16.5l2.3-1.3L12 19.5l7.9-4.3Z',
    ...
    // Los íconos de las subsecciones de Administración están dibujados en una rejilla de 24.
    $vb = in_array($ruta, ['/admin/estaciones', '/admin/usuarios', '/admin/catalogos'], true) ? '0 0 24 24' : '0 0 20 20';

    return '<svg class="sidebar__icon" viewBox="' . $vb . '" width="18" height="18" aria-hidden="true" focusable="false"><path d="' . $path . '" fill="currentColor"/></svg>';
}
