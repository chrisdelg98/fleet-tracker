            ...
            <?php foreach ($estaciones as $e): ?>
                <tr class="<?= (int) $e['activo'] === 0 ? 'is-inactive' : '' ?>">
                    ...
                    <td class="row-actions">
                        <?= row_menu([
                            ['label' => 'Editar', 'attrs' => ['data-action' => 'editar-estacion', 'data-id' => (int) $e['id']]],
                            ['label' => (int) $e['activo'] === 1 ? 'Desactivar' : 'Activar', 'attrs' => ['data-action' => 'activo-estacion', 'data-id' => (int) $e['id'], 'data-activo' => (int) $e['activo']]],
                        ]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
