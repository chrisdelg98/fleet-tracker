...
final class FlotaImportService extends ImportadorExcel
{
    ...
    protected function columnas(): array
    {
        return [
            ...
            ['clave' => 'combustible',       'label' => 'Combustible',         'ancho' => 16],
    ...
    protected function equivalencias(): array
    {
        return [
            ...
            'tipo_combustible_id'   => 'combustible',
    ...
    protected function traducir(array $cruda, array $indices, array $user): array
    {
        ...
        $input = [
            ...
            'tipo_combustible_id'   => $this->resolver($cruda, $indices, 'combustible', 'combustibles', 'los tipos de combustible', $errores),
    ...
    protected function indices(array $user): array
    {
        ...
        return $this->indiceEstaciones($this->catalogos) + [
            ...
            'combustibles' => $this->indicePorNombre($this->catalogos, 'tipos_combustible'),
            'pilotos'      => $pilotos,
            'permisos'     => $permisos,
            'estados'      => $estados,
        ];
    ...
    protected function listas(array $user): array
    {
        ...
        return [
            ...
            'combustible'       => $nombres($this->catalogos->activos('tipos_combustible', 'orden')),
    ...
    protected function ayuda(): array
    {
        return [
            ...
            'combustible'       => 'Opcional. Vacío para el equipo de arrastre, que no consume.',
    ...
    protected function ejemplo(array $listas): array
    {
        return [
            ...
            'modelo'            => 'Columbia',
            'anio'              => '2018',
            'combustible'       => $listas['combustible'][0] ?? '',
